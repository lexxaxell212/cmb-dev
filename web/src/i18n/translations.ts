const id = {
  ...
  'home.ctaSubtitle':
    'Pesan menu favoritmu atau sekadar mampir mencoba single origin terbaru kami. Sampai jumpa di Egi-Coffee!',
  ...
  'footer.rights': '© {year} Egi-Coffee. Semua hak dilindungi.',
...
const en: Record<TranslationKey, string> = {
  ...
  'home.ctaSubtitle':
    'Order your favorite or drop by to try our newest single origin. See you at Egi-Coffee!',
  ...
  'footer.rights': '© {year} Egi-Coffee. All rights reserved.',
